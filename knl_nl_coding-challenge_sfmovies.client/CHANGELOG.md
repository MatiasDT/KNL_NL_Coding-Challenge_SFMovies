...
- Create Angular project with ng: `ng new knl_nl_coding-challenge_sfmovies.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`knl_nl_coding-challenge_sfmovies.client.esproj`).
